...
class Wc_Afilnet_Html_output {
    ...
    public static function init($options = array()) {
        if (!empty($options)) {
            echo '<div id="afilnet-accordion" data-role="collapsible-set">';
            foreach ($options as $value) {
                ...
                switch ($value['type']) {
                    ...
                    case 'separator':
                        echo '<tr valign="top">'
                            .'<th>'
                                .'<hr style="border-top: 1px solid #83cefa;color: #fff;'
                                    .'background-color: #fff;height: 4px;">'
                                .'<h4>'.strtoupper($value['title']).'</h4>'
                                .'<hr style="border-top: 1px dashed #83cefa;color: #fff;'
                                    .'background-color: #fff;height: 4px;">'
                            .'</th>'
                            .'</tr>';
                        break;
                    ...
                    case 'textarea':
                        ...
                        ?><tr valign="top">
                            ...
                            <td class="forminp forminp-<?php echo sanitize_title($value['type']) ?>">
                            <?php
                            if (strpos($value['id'], 'email') !== false && strpos($value['id'], 'template') !== false){
                                $settings = array(
                                    "media_buttons" => false
                                );
                                wp_editor( self::get_option($value['id'], $value['default']), $value['id'], $settings);
                            } else {
                            ?>
                                <?php echo $description; ?>
                                <textarea
                ...
                if ($value['id']=="afilnet_settings_password"){
                    ?>
                    <tr valign="top">
                        <th scope="row" class="titledesc"></th>
                        <td class="forminp">
                            <input type="button" class="button" id="afilnet_login_button" name="afilnet_login_button" value="<?php esc_attr_e('Check', 'Option'); ?>"/>
                            <span id="apartadoCredenciales"></span>
                        </td>
                    </tr>
                    <?php
                }
